...
Question 1
   <img src="/src/assets/click (1).png" alt="Your Icon" className="w-4 h-4 inline-block ml-2" />
    ...
    <button className="block w-[90%] max-w-xs mx-auto bg-[#2E3837] hover:bg-[#FAF7FF] hover:text-[#2E3837] font-bold text-white rounded-2xl  py-3 font-[simple] mt-5">Question 2
    <img src="/src/assets/click (1).png" alt="Your Icon" className="w-4 h-4 inline-block ml-2" />
</button>
    <button className="block w-[90%] max-w-xs mx-auto bg-[#2E3837] hover:bg-[#FAF7FF] hover:text-[#2E3837] font-bold text-white rounded-2xl  py-3 font-[simple] mt-5">Question 3
    <img src="/src/assets/click (1).png" alt="Your Icon" className="w-4 h-4 inline-block ml-2" />
</button>
