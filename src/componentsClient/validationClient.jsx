  ...
  return (
    <>
      ...
      <div className="  flex   items-center self-center mx-auto  justify-between overflow-hidden container bg-[#FAF7FF] px-5  ">
        <div className=" bg-transparent flex-col  p-5 m-4 mx-auto rounded-3xl shadow-md  bg-white border border-gray-300 flex w-full   lg:w-[55%] ">

          <h1 className="text-center text-4xl lg:text-[34px] text-black font-[Inter]  m-5 "> Let’s go! </h1>

          <figure >
            <img src="/src/assets/sendEmail.png" alt="email@ " className='lg:h-[30%] lg:w-[30%] size-40 mx-auto max-w-lg    ' />
          </figure>
          <form onSubmit={handleSubmit(send)} className=" px-5 text-center flex flex-col  items-center justify-center mb-auto  ">
            ...
            <div className="flex">
              <div className=" px-3 mt-5 text-center">
                <button className="block w-[95%]   bg-[#ba7ea7] hover:bg-[#ba7ea7ec] hover:text-[#2E3837]  text-white rounded-2xl px-3 py-3 font-bold font-[simple] ">Verify</button>
              </div>
            </div>
          </form>
