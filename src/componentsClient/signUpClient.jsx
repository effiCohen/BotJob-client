                  ...
                  <div className="flex-mx-3">
                    <div className="w-full px-3 mb-2 text-start">
                      ...
                      <div className="flex">
                        ...
                        <input {...firstNameRef} type="text" className="w-full text-black -ml-10 pl-2  py-1 bg-white rounded-xl text-sm border-2  outline-none border-gray-300" placeholder="Johen" />
                      </div>
                    ...
                    <div className="w-full px-3 mb-2 text-start">
                      ...
                      <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className=" text-gray-400 text-lg"></i></div>
                        <input {...lastNameRef} type="text" className="w-full text-black -ml-10 pl-2  py-1 bg-white rounded-xl text-sm border-2  outline-none border-gray-300" placeholder="Due" />
                      </div>
                  ...
                  <div className="flex-mx-3">
                    <div className="w-full px-3 mb-2 text-start">
                      ...
                      <div className="flex">
                        ...
                        <input {...emailRef} type="email" className="w-full text-black -ml-10 pl-2  py-1 bg-white rounded-xl text-sm border-2  outline-none border-gray-300" placeholder="test@gmail.com" />
                      </div>
                  ...
                  <div className="flex-mx-3">
                    <div className="w-full px-3 mb-2 text-start">
                      ...
                      <div className="flex">
                        ...
                        <input  {...passwordRef} name='password' type="password" className="w-full text-black -ml-10 pl-2  py-1 bg-white rounded-xl text-sm border-2  outline-none border-gray-300" placeholder="password" />
                      </div>
