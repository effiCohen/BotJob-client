...
function HomeHistory() {
  ...
  <div className="relative flex items-center">
    <input
      ...
      name="username"
      type="text"
      className="border-b border-gray-300 py-1 focus:border-b-2 focus:border-gray-700 transition-colors focus:outline-none peer bg-inherit"
    />
    <label
      htmlFor="username"
      className="absolute left-0 top-1 cursor-text peer-focus:text-xs peer-focus:-top-4 transition-all peer-focus:text-black"
    >
      Search
    </label>
    <img src="/src/assets/8755997.gif" alt="Icon 1" className="h-4 w-4 mr-2" />
