                ...
                <div className="flex items-center justify-center p-5">
                    <div className="rounded-lg  p-5">
                        <div className="flex">
                            ...
                            <input type="text" value={searchText} onChange={handleChange} className="w-full max-w-[160px] bg-white pl-2 text-base font-semibold outline-0 shadow" placeholder="" id="" />
