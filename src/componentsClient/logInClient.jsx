            ...
            <div className="flex items-center justify-center ">
              <div className="w-full sm:w-64 px-1 mb-2 text-start">
                ...
                <div className="flex items-center justify-center">
                  ...
                  <input {...emailRef} type="email" className="w-full text-start text-sm -ml-10 pl-10 pr-3 py-1 bg-[#FAF7FF] rounded-xl border-2 border-[#292930c6] outline-none focus:border-gray-400 font-[Poppins]" placeholder="JohenDue@gmail.com" />
                </div>
