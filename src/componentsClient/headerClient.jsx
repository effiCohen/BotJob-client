    ...
    <div>
      {ifTokenExists ?
        <>
          ...
          <div className="navbar bg-gray-800 mb-auto top-0 rounded-xl w-full ">
            <div className="navbar-start">
              ...
              <img src="/src/assets/navlogo.png" onClick={onHomeClick} className='size-14' alt="" />
            </div>
            <div className="navbar-center hidden lg:flex">
              <ul className="menu justify-between menu-horizontal px-1">
                ...
                <li onClick={onHomeClick}><a>Item 1</a></li>
