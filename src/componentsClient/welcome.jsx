...
function Welcome() {
    ...
    return (
        <>
          <div class="border-double border-8 border-x-amber-200 border-y-white	" > 
                ...
                <div className="px-4 mx-auto max-w-6xl  lg:px-8 sm:flex sm:flex-col ">
                    <div className="grid max-w-lg grid-cols-1 mx-auto lg:max-w-full lg:items-center lg:grid-cols-2 gap-y-10 ">
                        <div>
                            ...
                            <div class="border-double border-4 border-y-amber-200 border-x-orange-300		" > 
                            
                            <h1 className="text-center text-[34px] font-bold text-gray-900 custom-heading">BotJob Ai</h1>
                                ...
                                <div className="flex justify-center  items-center lg:flex-col p-2 flex-col ">
                                    ...
                                    <div class="border-double border-4 border-x-amber-200 mb-5">
                                    <button
                                        class="w-[140px] h-[40px] shadow-2xl bg-white-100 outline outline-offset-2 outline-1 outline-sky-600 hover:scale-[1.03] hover:outline-none duration-300 active:scale-[0.99]"
                                    >
                                        <a class="font-bold" onClick={toLogin}>Login</a>
                                    </button>
                                    </div>

                                    <div class="border-double border-4 border-x-amber-200">
                                    <button
                                        class="w-[160px] h-[40px] shadow-2xl bg-white-100 outline outline-offset-2 outline-1 outline-sky-600 hover:scale-[1.03] hover:outline-none duration-300 active:scale-[0.99]"
                                    >
                                        <a class="font-bold" onClick={toSignUp}>Create an Account</a>
                                    </button>
                                    </div>
