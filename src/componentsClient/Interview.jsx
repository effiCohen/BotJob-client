  ...
  return (
    <>
      ...
      <div className="mb-3">{cuonter < myInterview.questions.length ?
        <button onClick={onNextClick} className="block w-[90%] max-w-xs mx-auto bg-[#B80672] hover:bg-[#ac5089] font-bold text-white rounded-2xl py-3 font-[Inter] mt-5">Next question</button> :
        <button onClick={onNextClick} className="block w-[90%] max-w-xs mx-auto bg-[#B80672] hover:bg-[#ac5089] font-bold text-white rounded-2xl py-3 font-[Inter] mt-5">Finish</button>}
      </div>
